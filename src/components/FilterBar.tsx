  ...
  return (
    <div className="flex flex-col sm:flex-row sm:items-center gap-4 mb-6">
        ...
        <button
          ...
          className={`flex-shrink-0 rounded-full px-3.5 py-1.5 text-xs font-medium transition-all duration-200
            ${selectedOrigin === null
              ...
              : 'bg-surface-card text-text-muted ring-1 ring-border-subtle hover:ring-border-amber hover:text-text-primary'
            }`}
        >
          {t('allOrigins')}
        </button>
      ...
      <select
        ...
        className="rounded-lg bg-surface-card text-text-secondary text-xs
          ring-1 ring-border-subtle px-3 py-2
