...
export default function CategoryCard({ category }: { category: Category }) {
  ...
  return (
    ...
    <Link
      ...
      className="group relative block overflow-hidden rounded-xl border border-border-amber bg-bg-card/80 p-7 transition-all duration-300 hover:border-amber/25 hover:bg-bg-card"
    >
      <div
